...
$(".infinity").click(function() {
  ...
  numberOfCountsOnSnap++;
  console.log("Snap clicked " + numberOfCountsOnSnap + " times.");
  snapCount.innerHTML = "Snap clicked " + numberOfCountsOnSnap + " times.";
